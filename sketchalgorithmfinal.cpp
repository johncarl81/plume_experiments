...
void sketch_algorithm ()
{
  ...
  //  for (int i = 0; i < SIDES; i ++){
   ...
   // }
    ...
    Drone B (Point (0.25,epsilon), Point (0.25,epsilon ), 1, 0, false);
    Drone A (Point (0.25,(DIST +1)* epsilon), Point ( 0.25, (DIST + 1)*epsilon), 1, 0, true);
...
{
    int i = 0;
    for (epsilon = 0.001; i < 10 ; epsilon += 0.001){
        INF = 4 * epsilon;
